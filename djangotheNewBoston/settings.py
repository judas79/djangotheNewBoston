"""
Django settings for djangotheNewBoston project.
...
SECRET_KEY = 'q+8odos=y*v-n_8dmsl7es$)nz^1l4q2-k9kln+21^zy%z6v#r'
...
ROOT_URLCONF = 'djangotheNewBoston.urls'
...
WSGI_APPLICATION = 'djangotheNewBoston.wsgi.application'
